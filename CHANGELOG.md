...
- Appendix C.2 heading corrected from "Single-bay auto repair shop" to "Single-location auto repair shop". The example file was renamed to `examples/v0.1/auto-repair-single-location.json` to match.
