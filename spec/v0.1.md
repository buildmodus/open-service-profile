...
**Status:** Draft v0.1, revised 2026-09-07 (revision 3), maintained by The Service Marketing Guys.
...
| MCP server card, agent-skills index | Transport discovery for MCP servers; the MCP Server Card working group is still defining the well-known metadata convention as of the 2026-07-28 release candidate. Agent skills give usage guidance for tools. | No domain vocabulary. The card shape OSP references in section 4.3 is an OSP convention until the MCP convention is final. |
